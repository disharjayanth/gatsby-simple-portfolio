  ...
  return (
    <div>
      ...
      <div className="mx-1 md:mx-10 px-4 md:px-10">
        ...
        <p className="font-medium text-xl md:text-2xl pt-2 hover:text-green-600">
          <a
        ...
        <p className="font-medium text-xl md:text-2xl pt-2 hover:text-purple-700">
          <a href="mailto:disharjayantha@protonmail.com">
